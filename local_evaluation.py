...
def evaluate(LocalEvalConfig):
    ...
    for fname in tqdm(file_names, desc="Evaluating results"):
        ...
        depth_prediction_aligned = align_monodepth_prediction(depth_annotation, depth_prediction)
        all_metrics[fname] = calculate_metrics(depth_annotation, depth_prediction_aligned)
